...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/SaputraTech/M4k4r0n1/main/data/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/SaputraTech/M4k4r0n1/main/data/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/SaputraTech/M4k4r0n1/main/data/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
