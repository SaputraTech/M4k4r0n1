...
sleep 2
wget -q -O /root/update.sh "https://raw.githubusercontent.com/SaputraTech/M4k4r0n1/main/data/update.sh" && chmod +x /root/update.sh
sleep 2
/root/./update.sh
rm /root/update.sh
#rm /opt/.ver
...
serverV=$( curl -sS https://raw.githubusercontent.com/SaputraTech/M4k4r0n1/main/data/version); ##### USING EXTERNAL LINK #####
